<template>
    <nav class="navbar">
      ...
      <div class="logout" v-if="isLoggedIn" @click="handleLogOut()" ><i class="fa-solid fa-right-from-bracket fa-2x"></i></div>

      <span class="last-titles"  v-if="!isLoggedIn">
    
      <RouterLink class="user"  to="/login"><i class="fa-solid fa-user fa-2x"></i></RouterLink>
